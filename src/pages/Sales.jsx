...
import {
  ...
  ShoppingCart, ChevronLeft, ChevronRight, Download,
    ...
    <>
      ...
      <div className="modal-footer">
        ...
        <button onClick={() => onSave({
          id: 'INV-2024-1029', date: new Date().toISOString().split('T')[0],
    ...
    <div className="space-y-5 animate-fadeIn">
      ...
      <div className="page-header">
        ...
        <div className="flex items-center gap-3">
          ...
          <button onClick={() => setModal('new')} className="btn-primary"><Plus size={16} />New Invoice</button>
        </div>
      </div>
                ...
                <tr key={s.id} className="animate-fadeIn" style={{ animationDelay: `${i * 25}ms` }}>
                  ...
                  <td>
                    <div className="flex items-center justify-center gap-1.5">
                      <button
                        onClick={() => { setSelectedSale(s); setModal('edit') }}
